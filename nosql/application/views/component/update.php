  ...
  <body>
    ...
    <div class="py-5 cover filter-gradient">
      <div class="container">
        <div class="card">
          <div class="card-body">
            <?php echo form_open('component/update')?>
            <input type="hidden" name="_id" value="<?php echo $_id ?>">
            <input type="text" name="c_brand" value="<?php echo $c_brand?>"> <br>
            <input type="text" name="c_name" value="<?php echo $c_name ?>"> <br>
            <input type="text" name="c_type" value="<?php echo $c_type ?>"> <br>
            <input type="text" name="c_code" value="<?php echo $c_code ?>"> <br>
            <input type="text" name="c_price->p_price" value="<?php echo $c_price->p_price ?>"> <br>
            <textarea name="c_description" rows="4" cols="60"><?php echo $c_description ?></textarea> <br>
